const translations = {
  de: {
    ...
    setup: {
      ...
      skirtingTitle: "Sockelleisten",
      tilePresets: "Fliesen-Presets",
      skirtingPresets: "Sockelleisten-Presets",
      skirtingPerRoom: "Sockelleisten pro Raum",
      presetName: "Name",
    ...
    floor: {
      ...
      calibrateHint: "Tipp: Verwenden Sie die längste verfügbare Referenz für beste Genauigkeit",
      ...
      calibrateFailedTitle: "Kalibrierung fehlgeschlagen",
      calibrateFailed: "Messungen weichen um {pct}% ab. Bitte mit längeren Referenzstrecken wiederholen.",
      calibrateRetry: "Erneut versuchen",
    ...
    skirting: {
      ...
      enableForRoom: "Für diesen Raum aktivieren",
    ...
    objects3d: {
      ...
      delete: "Löschen",
      object: "Objekt",
      noneSelected: "– kein Objekt ausgewählt –",
      properties: "Eigenschaften",
      label: "Bezeichnung",
      height: "Höhe (cm)",
      added: "3D-Objekt hinzugefügt",
      deleted: "3D-Objekt gelöscht",
      changed: "3D-Objekt geändert",
      moved: "3D-Objekt verschoben",
      resized: "3D-Objekt geändert",
      surfaceChanged: "Objektfläche geändert",
      heightPrompt: "Höhe des Objekts in cm:",
      add: "3D-Objekt hinzufügen",
      rectangle: "Rechteck",
      triangle: "Dreieck",
      freeform: "Freiform",
      addTri: "+ Dreieck",
    ...
    commercial: {
      ...
      packsSkirting: "Pakete Leisten",
      packsWall: "Pakete Wand",
    ...
    dialog: {
      ...
      cannotDeleteLastRoom: "Der letzte Raum kann nicht gelöscht werden",
      confirmDeleteFloorTitle: "Etage löschen?",
      confirmDeleteFloorText: "Möchten Sie \"{name}\" wirklich löschen? Alle Räume dieser Etage werden unwiderruflich gelöscht.",
  ...
  en: {
    ...
    floor: {
      ...
      calibrateHint: "Tip: Use the longest available reference for best accuracy",
      ...
      calibrateDone: "Done",
      calibrateFailedTitle: "Calibration failed",
      calibrateFailed: "Measurements vary by {pct}%. Please retry with longer reference distances.",
      calibrateRetry: "Retry",
    ...
    skirting: {
      ...
      enableForRoom: "Enable for this room",
    ...
    objects3d: {
      ...
      label: "Label",
      height: "Height (cm)",
      added: "3D object added",
      deleted: "3D object deleted",
      changed: "3D object changed",
      moved: "3D object moved",
      resized: "3D object resized",
      surfaceChanged: "Object surface changed",
      heightPrompt: "Object height in cm:",
      add: "Add 3D object",
      rectangle: "Rectangle",
      triangle: "Triangle",
      freeform: "Freeform",
    ...
    dialog: {
      ...
      cannotDeleteLastRoom: "Cannot delete the last room",
      confirmDeleteFloorTitle: "Delete Floor?",
      confirmDeleteFloorText: "Are you sure you want to delete \"{name}\"? All rooms on this floor will be permanently deleted.",
